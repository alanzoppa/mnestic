...
- Name: note-detail.spec.ts >> Note Detail Page >> should navigate to similar note on click
- Location: e2e/note-detail.spec.ts:53:7
...
Call log:
  - waiting for locator('div:has-text(\'1:1 with Alice - February 2024\')')
