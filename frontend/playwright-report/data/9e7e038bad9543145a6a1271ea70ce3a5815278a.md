...
- Name: search.spec.ts >> Search Page >> should have search input with placeholder
...
Locator: locator('input[placeholder="Search your notes..."]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="Search your notes..."]')
