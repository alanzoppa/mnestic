...
- Name: dashboard.spec.ts >> Dashboard >> should trigger incremental ingest and show result
- Location: e2e/dashboard.spec.ts:55:7
...
Call log:
  - waiting for locator('main').locator('button:has-text("Incremental Ingest")')
