...
- Name: browse.spec.ts >> Browse Page >> should display filter controls
- Location: e2e/browse.spec.ts:16:7
...
Locator: locator('select:has-text("All Sources")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('select:has-text("All Sources")')
