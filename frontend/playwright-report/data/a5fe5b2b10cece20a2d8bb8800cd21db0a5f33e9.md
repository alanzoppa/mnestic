...
- Name: note-detail.spec.ts >> Note Detail Page >> should display participants
- Location: e2e/note-detail.spec.ts:30:7
...
Locator: locator('header span:has-text(\'Alice\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header span:has-text(\'Alice\')')
