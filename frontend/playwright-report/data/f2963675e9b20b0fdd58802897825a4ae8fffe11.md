...
- Name: tags.spec.ts >> Tag Detail Page >> should have back button to tags page
- Location: e2e/tags.spec.ts:61:7
...
Locator: locator('text=Back to Tags')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Back to Tags')
