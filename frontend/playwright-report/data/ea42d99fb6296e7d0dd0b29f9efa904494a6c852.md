...
- Name: tags.spec.ts >> Tag Detail Page >> should display notes with this tag
- Location: e2e/tags.spec.ts:67:7
...
Locator: locator('h3:has-text(\'Zendesk Chat Architecture Review\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text(\'Zendesk Chat Architecture Review\')')
