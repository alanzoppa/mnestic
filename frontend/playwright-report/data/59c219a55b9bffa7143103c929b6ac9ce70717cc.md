...
- Name: note-detail.spec.ts >> Note Detail Page >> should navigate to tag page when tag clicked
- Location: e2e/note-detail.spec.ts:64:7
...
Call log:
  - waiting for locator('header a:has-text(\'management\')')
