...
- Name: calendar.spec.ts >> Calendar Page >> should navigate to day view on day click
- Location: e2e/calendar.spec.ts:36:7
...
Call log:
  - waiting for locator('div:has-text("15")').nth(1)
