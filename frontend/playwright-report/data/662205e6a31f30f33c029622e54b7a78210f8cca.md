...
- Name: note-detail.spec.ts >> Note Detail Page >> should display note title
- Location: e2e/note-detail.spec.ts:10:7
...
Locator: getByRole('heading', { name: '1:1 with Alice - March 2024' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '1:1 with Alice - March 2024' })
