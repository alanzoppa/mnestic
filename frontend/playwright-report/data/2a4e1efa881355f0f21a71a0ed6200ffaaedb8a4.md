...
- Name: tags.spec.ts >> Tags Page >> should display co-occurrence table
- Location: e2e/tags.spec.ts:41:7
...
Locator: locator('text=Top Co-occurring Tags')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Top Co-occurring Tags')
