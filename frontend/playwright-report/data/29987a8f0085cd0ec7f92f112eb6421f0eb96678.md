...
- Name: note-detail.spec.ts >> Note Detail Page >> should display note content
- Location: e2e/note-detail.spec.ts:35:7
...
Locator: locator('.markdown-body:has-text(\'Performance review preparation\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.markdown-body:has-text(\'Performance review preparation\')')
