...
- Name: tags.spec.ts >> Tags Page >> should have content tag indicator
- Location: e2e/tags.spec.ts:32:7
...
Locator: locator('text=Content').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Content').first()
