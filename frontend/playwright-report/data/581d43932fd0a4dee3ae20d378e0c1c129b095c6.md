...
- Name: tags.spec.ts >> Tags Page >> should have structural tag indicator
- Location: e2e/tags.spec.ts:28:7
...
Locator: locator('text=Structural').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Structural').first()
