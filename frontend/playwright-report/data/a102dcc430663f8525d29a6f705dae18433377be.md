...
- Name: nav.spec.ts >> Navigation >> should highlight active page in nav
- Location: e2e/nav.spec.ts:23:7
...
Locator: locator('nav').locator('a:has-text(\'Dashboard\')')
Expected pattern: /bg-zinc-700/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('nav').locator('a:has-text(\'Dashboard\')')
