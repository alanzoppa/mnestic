...
- Name: browse.spec.ts >> Browse Page >> should display note list items
- Location: e2e/browse.spec.ts:23:7
...
Locator: locator('h3:has-text(\'1:1 with Alice - March 2024\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text(\'1:1 with Alice - March 2024\')')
