...
- Name: dashboard.spec.ts >> Dashboard >> should have ingest management buttons
- Location: e2e/dashboard.spec.ts:44:7
...
Locator: locator('main').locator('text=Index Management')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('main').locator('text=Index Management')
