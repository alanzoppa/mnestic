...
- Name: calendar.spec.ts >> Calendar Page >> should display page title
- Location: e2e/calendar.spec.ts:10:7
...
Locator: locator('main').getByRole('heading', { name: 'Calendar' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('main').getByRole('heading', { name: 'Calendar' })
