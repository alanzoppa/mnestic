...
- Name: dashboard.spec.ts >> Dashboard >> should navigate to search page via Advanced Search link
- Location: e2e/dashboard.spec.ts:70:7
...
Call log:
  - waiting for locator('a:has-text("Advanced Search")')
