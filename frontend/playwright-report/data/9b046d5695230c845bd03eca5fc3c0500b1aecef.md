...
- Name: note-detail.spec.ts >> Note Detail Page >> should display same-day calendar events sidebar
- Location: e2e/note-detail.spec.ts:41:7
...
Locator: locator('h3:has-text(\'Same-day Events\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text(\'Same-day Events\')')
