...
- Name: graph.spec.ts >> Graph Page >> should have similarity threshold slider
- Location: e2e/graph.spec.ts:19:7
...
Locator: locator('text=Similarity:').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Similarity:').first()
