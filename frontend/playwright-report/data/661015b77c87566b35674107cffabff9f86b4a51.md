...
- Name: dashboard.spec.ts >> Dashboard >> should display app title and stats
...
Locator: locator('main').getByRole('heading', { name: 'Notes Browser' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('main').getByRole('heading', { name: 'Notes Browser' })
