...
- Name: note-detail.spec.ts >> Note Detail Page >> should display tags as clickable links
- Location: e2e/note-detail.spec.ts:22:7
...
Locator: locator('header a:has-text(\'1:1\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('header a:has-text(\'1:1\')')
