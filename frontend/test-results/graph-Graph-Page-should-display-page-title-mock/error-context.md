...
- Name: graph.spec.ts >> Graph Page >> should display page title
- Location: e2e/graph.spec.ts:10:7
...
Locator: getByRole('heading', { name: 'Similarity Graph' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Similarity Graph' })
