...
- Name: calendar.spec.ts >> Calendar Page >> should have attendee filter
- Location: e2e/calendar.spec.ts:41:7
...
Locator: locator('input[placeholder="Filter by attendee..."]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="Filter by attendee..."]')
