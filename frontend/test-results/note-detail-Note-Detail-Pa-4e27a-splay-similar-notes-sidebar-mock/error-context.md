...
- Name: note-detail.spec.ts >> Note Detail Page >> should display similar notes sidebar
- Location: e2e/note-detail.spec.ts:47:7
...
Locator: locator('h3:has-text(\'Similar Notes\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text(\'Similar Notes\')')
