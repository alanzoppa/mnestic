...
- Name: dashboard.spec.ts >> Dashboard >> should have search functionality
...
Locator: locator('main').locator('input[placeholder="Search notes..."]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('main').locator('input[placeholder="Search notes..."]')
