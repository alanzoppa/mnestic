...
- Name: timeline.spec.ts >> Timeline Page >> should display period count summary
- Location: e2e/timeline.spec.ts:23:7
...
Locator: locator('text=notes across')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=notes across')
