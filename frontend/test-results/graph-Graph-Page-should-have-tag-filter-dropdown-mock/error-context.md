...
- Name: graph.spec.ts >> Graph Page >> should have tag filter dropdown
- Location: e2e/graph.spec.ts:14:7
...
Locator: locator('text=Tag:').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Tag:').first()
