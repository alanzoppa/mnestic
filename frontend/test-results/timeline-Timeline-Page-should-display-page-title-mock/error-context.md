...
- Name: timeline.spec.ts >> Timeline Page >> should display page title
- Location: e2e/timeline.spec.ts:10:7
...
Locator: getByRole('heading', { name: 'Timeline' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Timeline' })
