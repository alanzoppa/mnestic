...
- Name: dashboard.spec.ts >> Dashboard >> should navigate to browse page via Browse All link
- Location: e2e/dashboard.spec.ts:76:7
...
Call log:
  - waiting for locator('a:has-text("Browse All")')
