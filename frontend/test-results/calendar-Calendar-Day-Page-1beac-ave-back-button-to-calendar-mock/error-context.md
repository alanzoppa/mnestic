...
- Name: calendar.spec.ts >> Calendar Day Page >> should have back button to calendar
- Location: e2e/calendar.spec.ts:68:7
...
Locator: locator('text=Back to Calendar')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Back to Calendar')
