...
- Name: browse.spec.ts >> Browse Page >> should show tags on note cards
- Location: e2e/browse.spec.ts:31:7
...
Locator: locator('span:has-text("1:1").bg-zinc-800').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('span:has-text("1:1").bg-zinc-800').first()
